...
OBJS=avr_common/uart.o syscall.o process.o core.o atom_avr.o scheduler.o memory.o

# put here the additional header files needed for compilation
HEADERS=avr_common/uart.h syscall.h process.h core.h scheduler.h memory.h
